...
import { Alba, FocusCircle, Profile, ProfileWhite, Report, ReportWhite, Task } from "../../../assets";
  ...
  return (
    <View style={OnboardingStyles.container}>
      ...
      <View style={[OnboardingStyles.highlightView, OnboardingStyles.highlight]}>
        <Text style={[OnboardingStyles.onBoardingText, {marginTop: 30}]}>PROFILE</Text>
        <Text style={[OnboardingStyles.onBoardingText]}>
          Fine tune your family and account settings.
        </Text>
        <TouchableOpacity style={OnboardingStyles.nextButton}
          onPress={() => onNext()}
        >
          <Text style={AppStyles.formButtonText}>Got it</Text>
        </TouchableOpacity>
